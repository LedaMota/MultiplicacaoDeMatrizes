...
namespace Multiplicar_Matrizes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            resultado[1, 0] = (matriz1[1, 0] * matriz2[0, 1]) + (matriz1[1, 1] * matriz2[1, 1]) + (matriz1[1, 2] * matriz2[2, 1]);


            resultado[1, 0] = (matriz1[1, 0] * matriz2[1, 0]) + (matriz1[0, 1] * matriz2[1, 1]) + (matriz1[0, 2] * matriz2[2, 1]);

            resultado[1, 1] = (matriz1[0, 0] * matriz2[1, 1]) + (matriz1[1, 1] * matriz2[1, 1]) + (matriz1[1, 2] * matriz2[2, 1]);
